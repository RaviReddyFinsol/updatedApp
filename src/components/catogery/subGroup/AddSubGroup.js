        ...
        return (
            <React.Fragment>
            {
                this.props.groups.length !== 0 ? ( 
                    ...
                    <TextField label="SGN" name="subGroupName" onChange={this.inputChanged} value={this.state.subGroupName}/><br />
                   
                        {"G"}  <Select value={this.state.groupName} onChange={this.inputChanged} name="groupName">
                           {  this.props.groups.map(group => ((<MenuItem key={group._id} value={group.groupName}> {group.groupName} </MenuItem>))) }
                         </Select>  
                    <br />
