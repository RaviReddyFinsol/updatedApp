            ...
            <React.Fragment>
                {
                    this.props.groups.length !== 0 ? (
                        <form onSubmit={this.saveGroup}>
                            ...
                            />
                            <br />
                            <Select value={this.state.groupName} onChange={this.inputChanged} name="groupName">
                                {
                                    this.props.groups ? (
                                        this.props.groups.map(group => (<MenuItem value={group._id}> {group.groupName} </MenuItem>))) : (<MenuItem value={""}></MenuItem>)
                                }
                            </Select>
                            <br />
...
export default connect(mapStateToProps, { getGroups })(EditSubGroup);
